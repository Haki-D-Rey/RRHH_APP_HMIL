...
Public Class Frm_Movimientos_Exp_Imprimir
    Private Sub Frm_Movimientos_Exp_Imprimir_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Movimientos_Exp_Imprimir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button01_Click(sender As Object, e As EventArgs) Handles Button01.Click
        If Me.ComboBox1.Text = "CRYSTAL" Then
            ...
            D1 = Mid(Frm_Movimientos_Exp.DateTimePicker1.Value, 1, 2)
            M1 = Mid(Frm_Movimientos_Exp.DateTimePicker1.Value, 4, 2)
            A1 = Mid(Frm_Movimientos_Exp.DateTimePicker1.Value, 7, 4)
            D2 = Mid(Frm_Movimientos_Exp.DateTimePicker2.Value, 1, 2)
            M2 = Mid(Frm_Movimientos_Exp.DateTimePicker2.Value, 4, 2)
            A2 = Mid(Frm_Movimientos_Exp.DateTimePicker2.Value, 7, 4)
            If isuID_TIPO_USUARIO = 5 Then
                If Me.CheckBox1.Checked = False Then
                    SELECCION = "(({HISTORICO_DE_MOVIMIENTO.FEC_MOV} = CDateTime (" & A1 & ", " & M1 & ", " & D1 & ") TO CDateTime (" & A2 & ", " & M2 & ", " & D2 & "))) AND ({HISTORICO_DE_MOVIMIENTO.ID_T_M_EXP} = " & Frm_Movimientos_Exp.ComboBox1.SelectedValue & ") AND ({MAESTRO_DE_PERSONAS.ID_ADMIN} = " & isuUSUARIO_R & ")"
                Else
                    SELECCION = "(({HISTORICO_DE_MOVIMIENTO.FEC_MOV} = CDateTime (" & A1 & ", " & M1 & ", " & D1 & ") TO CDateTime (" & A2 & ", " & M2 & ", " & D2 & "))) AND ({MAESTRO_DE_PERSONAS.ID_ADMIN} = " & isuUSUARIO_R & ")"
                End If
            Else
                If Me.CheckBox1.Checked = False Then
                    SELECCION = "(({HISTORICO_DE_MOVIMIENTO.FEC_MOV} = CDateTime (" & A1 & ", " & M1 & ", " & D1 & ") TO CDateTime (" & A2 & ", " & M2 & ", " & D2 & "))) AND ({HISTORICO_DE_MOVIMIENTO.ID_T_M_EXP} = " & Frm_Movimientos_Exp.ComboBox1.SelectedValue & ")"
                Else
                    SELECCION = "(({HISTORICO_DE_MOVIMIENTO.FEC_MOV} = CDateTime (" & A1 & ", " & M1 & ", " & D1 & ") TO CDateTime (" & A2 & ", " & M2 & ", " & D2 & ")))"
                End If
            End If
            PARAMETRO = 3
        ...
        If Me.ComboBox1.Text = "PDF" Then
            ...
            cryRpt.Load(PathRPT & "SPYC003.rpt")
