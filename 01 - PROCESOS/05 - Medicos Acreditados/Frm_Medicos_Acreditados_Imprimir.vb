...
Public Class Frm_Medicos_Acreditados_Imprimir
    Private Sub Frm_Medicos_Acreditados_Imprimir_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Medicos_Acreditados_Imprimir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
SALIR:
        ...
        If Me.ComboBox1.Text = "PDF" Then
            ...
            cryRpt.Load(PathRPT & "SPYC011.rpt")
