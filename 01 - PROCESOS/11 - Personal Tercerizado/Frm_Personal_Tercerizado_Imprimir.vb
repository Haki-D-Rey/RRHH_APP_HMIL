...
Public Class Frm_Personal_Tercerizado_Imprimir
    Private Sub Frm_Personal_Tercerizado_Imprimir_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Personal_Tercerizado_Imprimir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button01_Click(sender As Object, e As EventArgs) Handles Button01.Click
        If Me.ComboBox1.Text = "CRYSTAL" Then
            ...
            If Me.CheckBox1.Checked = False Then
                SELECCION = "({MAESTRO_DE_PERSONAL_TERCERIZADO.ID_E_T} = " & Frm_Personal_Tercerizado.ComboBox1.SelectedValue & ")"
            Else
                SELECCION = ""
            End If
            PARAMETRO = 15
        ...
        If Me.ComboBox1.Text = "PDF" Then
            ...
            cryRpt.Load(PathRPT & "SPYC015.rpt")
