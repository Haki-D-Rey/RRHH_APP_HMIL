...
Public Class Frm_Expedientes_Inactivos_Buscar
    Private Sub Frm_Expedientes_Inactivos_Buscar_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Expedientes_Inactivos_Buscar_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = "0"
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        CADENAsql1 = "ID_M_P, FEC_NAC, FEC_ING_PAME, FEC_ING_EN, CODIGO, APELLIDOS, NOMBRES, AN, ID_T_SEXO, D_T_SEXO, " &
             ...
             "ID_ESTADO_P, BECADO, EDAD, ANTIGUEDAD_PAME, ANTIGUEDAD_EN"
        If isuID_TIPO_USUARIO = 5 Then
            If Me.RadioButton1.Checked = True Then
                CADENAsql = "Select " & CADENAsql1 & " from [VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (CODIGO LIKE '%" & Me.TextBox2.Text & "%') AND D_ADMIN = '" & isuUSUARIO & "' ORDER BY AN"
                GoTo SALTO
            End If
            If Me.RadioButton2.Checked = True Then
                If Me.CheckBox1.Checked = False Then
                    ...
                    If tamañoArreglo = 0 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (CODIGO <> '0000000000') AND (AN LIKE '%" & Me.TextBox2.Text & "%') AND D_ADMIN = '" & isuUSUARIO & "'"
                    ElseIf tamañoArreglo = 1 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (CODIGO <> '0000000000') AND AN LIKE '%" & buscar & "%' AND D_ADMIN = '" & isuUSUARIO & "'"
                    ElseIf tamañoArreglo > 1 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (CODIGO <> '0000000000') AND AN LIKE '%" & ArrCadena(0) & "%' AND D_ADMIN = '" & isuUSUARIO & "'"
                        For index = 0 To ArrCadena.GetUpperBound(0)
                            CADENAsql = CADENAsql & " UNION Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (CODIGO <> '0000000000') AND AN LIKE '%" & ArrCadena(index) & "%' AND D_ADMIN = '" & isuUSUARIO & "'"
                        Next
                    End If
                ...
                If Me.CheckBox1.Checked = True Then
                    CADENAsql = "Select " & CADENAsql1 & " from [VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (AN LIKE '%" & Me.TextBox2.Text & "%') AND D_ADMIN = '" & isuUSUARIO & "' ORDER BY AN"
                End If
            End If
        Else
            If Me.RadioButton1.Checked = True Then
                CADENAsql = "Select " & CADENAsql1 & " from [VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (CODIGO LIKE '%" & Me.TextBox2.Text & "%') ORDER BY AN"
                GoTo SALTO
            End If
            If Me.RadioButton2.Checked = True Then
                If Me.CheckBox1.Checked = False Then
                    ...
                    tamañoArreglo = ArrCadena.GetUpperBound(0) + 1
                    If tamañoArreglo = 0 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (CODIGO <> '0000000000') AND (AN LIKE '%" & Me.TextBox2.Text & "%')"
                    ElseIf tamañoArreglo = 1 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (CODIGO <> '0000000000') AND AN LIKE '%" & buscar & "%'"
                    ElseIf tamañoArreglo > 1 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (CODIGO <> '0000000000') AND AN LIKE '%" & ArrCadena(0) & "%' "
                        For index = 0 To ArrCadena.GetUpperBound(0)
                            CADENAsql = CADENAsql & " UNION Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (CODIGO <> '0000000000') AND AN LIKE '%" & ArrCadena(index) & "%'"
                        Next
                    End If
                    CADENAsql = CADENAsql & "  ORDER BY AN"
                    GoTo SALTO
                End If
                If Me.CheckBox1.Checked = True Then
                    CADENAsql = "Select " & CADENAsql1 & " from [VISTA MAESTRO DE PERSONAS] WHERE ID_ESTADO_P = '2' AND (AN LIKE '%" & Me.TextBox2.Text & "%') ORDER BY AN"
                End If
            End If
        End If
SALTO:
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        ...
        Me.DGV.Columns(62).Width = 0
        Me.DGV.Columns(62).Visible = False
        ...
        Me.DGV.Columns(64).Width = 0
        Me.DGV.Columns(64).Visible = False
