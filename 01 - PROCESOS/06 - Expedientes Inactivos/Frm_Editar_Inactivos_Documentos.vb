...
Public Class Frm_Editar_Inactivos_Documentos
    Private Sub Frm_Editar_Inactivos_Documentos_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Editar_Inactivos_Documentos_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
