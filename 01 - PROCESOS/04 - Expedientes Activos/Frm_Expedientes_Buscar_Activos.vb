...
Public Class Frm_Expedientes_Buscar_Activos
    Private Sub Frm_Expedientes_Buscar_Activos_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Expedientes_Buscar_Activos_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = "0"
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        If isuID_TIPO_USUARIO = 5 Then
            If Me.RadioButton1.Checked = True Then
                CADENAsql = "Select * from [VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (CODIGO LIKE '%" & Me.TextBox2.Text & "%') AND D_ADMIN = '" & isuUSUARIO & "' ORDER BY AN"
                GoTo SALTO
            End If
            If Me.RadioButton2.Checked = True Then
                If Me.CheckBox1.Checked = False Then
                    ...
                    If tamañoArreglo = 0 Then
                        CADENAsql = "SELECT * FROM [dbo].[VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (CODIGO <> '0000000000') AND (AN LIKE '%" & Me.TextBox2.Text & "%') AND D_ADMIN = '" & isuUSUARIO & "'"
                    ElseIf tamañoArreglo = 1 Then
                        CADENAsql = "SELECT * FROM [dbo].[VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (CODIGO <> '0000000000') AND AN LIKE '%" & buscar & "%' AND D_ADMIN = '" & isuUSUARIO & "'"
                    ElseIf tamañoArreglo > 1 Then
                        CADENAsql = "SELECT * FROM [dbo].[VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (CODIGO <> '0000000000') AND AN LIKE '%" & ArrCadena(0) & "%' AND D_ADMIN = '" & isuUSUARIO & "'"
                        For index = 0 To ArrCadena.GetUpperBound(0)
                            CADENAsql = CADENAsql & " UNION SELECT * FROM [dbo].[VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (CODIGO <> '0000000000') AND AN LIKE '%" & ArrCadena(index) & "%' AND D_ADMIN = '" & isuUSUARIO & "'"
                        Next
                    End If
                ...
                If Me.CheckBox1.Checked = True Then
                    CADENAsql = "Select * from [VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (AN LIKE '%" & Me.TextBox2.Text & "%') AND D_ADMIN = '" & isuUSUARIO & "' ORDER BY AN"
                End If
            End If
            If Me.RadioButton3.Checked = True Then
                CADENAsql = "Select * from [VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (N_ORDEN_MIXTA LIKE '%" & Me.TextBox2.Text & "%') AND D_ADMIN = '" & isuUSUARIO & "' ORDER BY AN"
                GoTo SALTO
            End If
        Else
            If Me.RadioButton1.Checked = True Then
                CADENAsql = "Select * from [VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (CODIGO LIKE '%" & Me.TextBox2.Text & "%') ORDER BY AN"
                GoTo SALTO
            End If
            If Me.RadioButton2.Checked = True Then
                If Me.CheckBox1.Checked = False Then
                    ...
                    tamañoArreglo = ArrCadena.GetUpperBound(0) + 1
                    If tamañoArreglo = 0 Then
                        CADENAsql = "SELECT * FROM [dbo].[VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (CODIGO <> '0000000000') AND (AN LIKE '%" & Me.TextBox2.Text & "%')"
                    ElseIf tamañoArreglo = 1 Then
                        CADENAsql = "SELECT * FROM [dbo].[VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (CODIGO <> '0000000000') AND AN LIKE '%" & buscar & "%'"
                    ElseIf tamañoArreglo > 1 Then
                        CADENAsql = "SELECT * FROM [dbo].[VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (CODIGO <> '0000000000') AND AN LIKE '%" & ArrCadena(0) & "%' "
                        For index = 0 To ArrCadena.GetUpperBound(0)
                            CADENAsql = CADENAsql & " UNION SELECT * FROM [dbo].[VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (CODIGO <> '0000000000') AND AN LIKE '%" & ArrCadena(index) & "%'"
                        Next
                    End If
                    CADENAsql = CADENAsql & "  ORDER BY AN"
                    GoTo SALTO
            ...
            End If
            If Me.RadioButton3.Checked = True Then
                CADENAsql = "Select * from [VISTA MAESTRO DE CARGOS] WHERE ID_SITUACION = '1' AND (N_ORDEN_MIXTA LIKE '%" & Me.TextBox2.Text & "%') ORDER BY AN"
                GoTo SALTO
            End If
        End If
SALTO:
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    ...
                    bCODIGO = Me.DGV.Item(40, I).Value
                    Exit Sub
                End If
            Next
        End If
