...
Public Class Frm_Estructura_Org_Buscar
    Private Sub Frm_Estructura_Org_Buscar_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Estructura_Org_Buscar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = "0"
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    ...
                    vID_M_P = Me.DGV.Item(40, I).Value
                    cEMPLEADO = Me.DGV.Item(31, I).Value
