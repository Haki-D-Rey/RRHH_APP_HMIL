...
Imports System.IO
Public Class Frm_Estructura_Org_Agregar
    ...
    Private Sub CARGAR_COMBO_CAT_DE_SITUACION()
        ...
        End Try
    End Sub
    Private Sub CARGAR_COMBO_CAT_DE_CARGOS_DE_ESTRUCTURA_2()
        If Conexion.CxRRHH.State = ConnectionState.Open Then
            Conexion.CBD_RRHH()
        End If
        Conexion.ABD_RRHH()
    ...
    Private Sub CARGAR_COMBO_CAT_DE_ESTABLECIMIENTO()
        ...
        End Try
    End Sub
    Private Sub Frm_Estructura_Org_Agregar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = "0"
        ...
        Me.ComboBox5.Text = "VACANTE"
        Me.CheckBox2.Checked = True
        Me.CheckBox3.Checked = False
        Me.CheckBox4.Checked = False
        Me.TextBox37.Text = ""
        Call CARGAR_COMBO_CAT_DE_ESTABLECIMIENTO()
        Me.CARGAR_COMBO_CAT_DE_CARGOS_DE_ESTRUCTURA_2()
        Call CARGAR_COMBO_CAT_DE_TIPO_DE_ESTRUCTURA()
        Me.ComboBox8.Text = vmcsD_CARGO_ES
        Me.RadioButton1.Enabled = True
        Me.RadioButton2.Enabled = True
        Me.ComboBox1.Focus()
    End Sub
    Private Sub Frm_Estructura_Org_Agregar_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub ComboBox2_KeyDown(sender As Object, e As KeyEventArgs) Handles ComboBox2.KeyDown
        If e.KeyCode = Keys.Enter Then
            e.Handled = True
            Me.ComboBox3.Text = Me.ComboBox2.Text
            SendKeys.Send("{TAB}")
        End If
    End Sub
    ...
    Private Sub GENERAR_CODIGO()
        ...
        Conexion.ABD_RRHH()
        Try
            MiDataAdapter = New SqlDataAdapter("SELECT ID_M_C FROM [MAESTRO DE CARGOS] ORDER BY ID_M_C", Conexion.CxRRHH)
            MiDataTable.Clear()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Me.CheckBox3.Checked = True And Val(Me.TextBox37.Text) = 0 Then
            ...
            Exit Sub
        End If
        If Frm_Estructura_Org.DGV3.RowCount <> 0 Then
            If Me.RadioButton1.Checked = False And Me.RadioButton2.Checked = False Then
                MsgBox("Debe seleccionar la posicion del registro que desea Agregar", vbInformation, "Mensaje del Sistema")
    ...
    Private Sub AGREGAR_REGISTRO()
        ...
        If vN11 = 0 Then : vN1 = "NULL" : Else : vN1 = Frm_Estructura_Org.ComboBox1.SelectedValue : End If
        If vN22 = 0 Then : vN2 = "NULL" : Else : vN2 = Frm_Estructura_Org.ComboBox2.SelectedValue : End If
        If vN33 = 0 Then : vN3 = "NULL" : Else : vN3 = Frm_Estructura_Org.ComboBox3.SelectedValue : End If
        If vN44 = 0 Then : vN4 = "NULL" : Else : vN4 = Frm_Estructura_Org.ComboBox4.SelectedValue : End If
        If vN55 = 0 Then : vN5 = "NULL" : Else : vN5 = Frm_Estructura_Org.ComboBox5.SelectedValue : End If
        If vN66 = 0 Then : vN6 = "NULL" : Else : vN6 = Frm_Estructura_Org.ComboBox6.SelectedValue : End If
        If vN77 = 0 Then : vN7 = "NULL" : Else : vN7 = Frm_Estructura_Org.ComboBox7.SelectedValue : End If
        If vN88 = 0 Then : vN8 = "NULL" : Else : vN8 = Frm_Estructura_Org.ComboBox8.SelectedValue : End If
        If Conexion.CxRRHH.State = ConnectionState.Open Then
            Conexion.CBD_RRHH()
        End If
        Conexion.ABD_RRHH()
        ...
        Try
            MiSqlCommand.CommandText = "INSERT INTO [MAESTRO DE CARGOS] (ID_M_C, ORDEN, ID_N1, ID_N2, ID_N3, ID_N4, ID_N5, ID_N6, ID_N7, ID_N8, ID_T_ES, N_ORDEN_MIXTA, N_ORDEN_MILITAR, N_ORDEN_PAME, ID_CARGO_ES, ID_GP, ID_GR, ID_CAT_SALARIAL, ID_M_P, ID_SITUACION, JEFE, MIXTA, MILITAR, PAME, ID_ESTABLECIMIENTO)" &
                                  "values (" & CInt(Me.TextBox1.Text) & ", '" & vORDEN & "', " & vN1 & ", " & vN2 & ", " & vN3 & ", " & vN4 & ", " & vN5 & ", " & vN6 & ", " & vN7 & ", " & vN8 & ", " & Me.ComboBox7.SelectedValue & ", '" & Format(CInt(vORDEN), "0000") & "', '" & Format(Val(Me.TextBox37.Text), "0000") & "', '" & Format(CInt(vORDEN), "0000") & "', " & Me.ComboBox1.SelectedValue & ", " & Me.ComboBox2.SelectedValue & ", " & Me.ComboBox3.SelectedValue & ", " & Me.ComboBox4.SelectedValue & ", 1, " & Me.ComboBox5.SelectedValue & ", '" & Me.CheckBox1.Checked & "', '" & Me.CheckBox2.Checked & "', '" & Me.CheckBox3.Checked & "', '" & Me.CheckBox4.Checked & "', " & Me.ComboBox6.SelectedValue & ")"
