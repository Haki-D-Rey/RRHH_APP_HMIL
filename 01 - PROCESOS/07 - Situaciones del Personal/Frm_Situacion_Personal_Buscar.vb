...
Public Class Frm_Situacion_Personal_Buscar
    Private Sub Frm_Situacion_Personal_Buscar_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Situacion_Personal_Buscar_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = "0"
