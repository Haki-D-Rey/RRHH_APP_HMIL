...
Public Class SPYCS108x_ORIGINAL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SPYC3.SPYCS108x ORIGINAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSPYCS108x_ORIGINAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SPYCS108x_ORIGINAL = New SPYCS108x_ORIGINAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
