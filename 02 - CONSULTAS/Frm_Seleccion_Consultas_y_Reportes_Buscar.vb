...
Public Class Frm_Seleccion_Consultas_y_Reportes_Buscar
    Private Sub Frm_Seleccion_Consultas_y_Reportes_Buscar_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Seleccion_Consultas_y_Reportes_Buscar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = "0"
     ...
     "ID_ESTADO_P, BECADO, EDAD, ANTIGUEDAD_PAME, ANTIGUEDAD_EN"
        If isuID_TIPO_USUARIO = 5 Then
            If Me.RadioButton1.Checked = True Then
                CADENAsql = "Select " & CADENAsql1 & " from [VISTA MAESTRO DE PERSONAS] WHERE (CODIGO LIKE '%" & Me.TextBox2.Text & "%') AND D_ADMIN = '" & isuUSUARIO & "' ORDER BY AN"
                GoTo SALTO
            End If
            If Me.RadioButton2.Checked = True Then
                If Me.CheckBox1.Checked = False Then
                    ...
                    If tamañoArreglo = 0 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE (AN LIKE '%" & Me.TextBox2.Text & "%') AND D_ADMIN = '" & isuUSUARIO & "'"
                    ElseIf tamañoArreglo = 1 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE AN LIKE '%" & buscar & "%' AND D_ADMIN = '" & isuUSUARIO & "'"
                    ElseIf tamañoArreglo > 1 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE AN LIKE '%" & ArrCadena(0) & "%' AND D_ADMIN = '" & isuUSUARIO & "'"
                        For index = 0 To ArrCadena.GetUpperBound(0)
                            CADENAsql = CADENAsql & " UNION Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE AN LIKE '%" & ArrCadena(index) & "%' AND D_ADMIN = '" & isuUSUARIO & "'"
                        Next
                    End If
                ...
                If Me.CheckBox1.Checked = True Then
                    CADENAsql = "Select " & CADENAsql1 & " from [VISTA MAESTRO DE PERSONAS] WHERE (AN LIKE '%" & Me.TextBox2.Text & "%') AND D_ADMIN = '" & isuUSUARIO & "' ORDER BY AN"
                End If
            End If
        Else
            If Me.RadioButton1.Checked = True Then
                CADENAsql = "Select " & CADENAsql1 & " from [VISTA MAESTRO DE PERSONAS] WHERE (CODIGO LIKE '%" & Me.TextBox2.Text & "%') ORDER BY AN"
                GoTo SALTO
            End If
            If Me.RadioButton2.Checked = True Then
                If Me.CheckBox1.Checked = False Then
                    ...
                    tamañoArreglo = ArrCadena.GetUpperBound(0) + 1
                    If tamañoArreglo = 0 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE (AN LIKE '%" & Me.TextBox2.Text & "%')"
                    ElseIf tamañoArreglo = 1 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE AN LIKE '%" & buscar & "%'"
                    ElseIf tamañoArreglo > 1 Then
                        CADENAsql = "Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE AN LIKE '%" & ArrCadena(0) & "%' "
                        For index = 0 To ArrCadena.GetUpperBound(0)
                            CADENAsql = CADENAsql & " UNION Select " & CADENAsql1 & " FROM [dbo].[VISTA MAESTRO DE PERSONAS] WHERE AN LIKE '%" & ArrCadena(index) & "%'"
                        Next
                    End If
                    CADENAsql = CADENAsql & "  ORDER BY AN"
                    GoTo SALTO
                End If
                If Me.CheckBox1.Checked = True Then
                    CADENAsql = "Select " & CADENAsql1 & " from [VISTA MAESTRO DE PERSONAS] WHERE  (AN LIKE '%" & Me.TextBox2.Text & "%') ORDER BY AN"
                End If
            End If
        End If
SALTO:
