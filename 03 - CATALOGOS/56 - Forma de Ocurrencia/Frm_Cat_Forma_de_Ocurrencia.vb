...
Public Class Frm_Cat_Forma_de_Ocurrencia
    Private Sub Frm_Cat_Forma_de_Ocurrencia_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Forma_de_Ocurrencia_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE FORMA DE OCURRENCIA] ORDER BY ID_FO", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE FORMA DE OCURRENCIA]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE FORMA DE OCURRENCIA]")
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE FORMA DE OCURRENCIA] WHERE ID_FO = " & CInt(c44ID_F) & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Forma_de_Ocurrencia_Add.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c44ID_F = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Forma_de_Ocurrencia_Upd.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "FORMA DE OCURRENCIA (" & UCase(Now) & ")")
        Catch ex As Exception
