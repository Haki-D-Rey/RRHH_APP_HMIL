...
Public Class Frm_Cat_Agregar_T_Horario
    Private Sub Frm_Cat_Agregar_T_Horario_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = ""
        Me.TextBox2.Text = ""
        Call Clases.BUSCAR_FECHA_Y_HORA()
        Me.DateTimePicker1.Value = Convert.ToDateTime(HORA.ToString)
        Me.DateTimePicker2.Value = Convert.ToDateTime(HORA.ToString)
        Me.TextBox3.Text = "0"
        Me.TextBox4.Text = "0"
        Me.TextBox5.Text = "0"
    ...
    Private Sub Button2_Click(sender As Object, e As System.EventArgs) Handles Button2.Click
        ...
        Me.Close()
    End Sub
    Private Sub Frm_Cat_Agregar_T_Horario_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub GENERAR_CODIGO()
        ...
        Conexion.ABD_RRHH()
        Try
            MiDataAdapter = New SqlDataAdapter("SELECT ID_T_HORARIO FROM [CAT DE TIPO DE HORARIO] ORDER BY ID_T_HORARIO", Conexion.CxRRHH)
            MiDataTable.Clear()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Len(Me.TextBox3.Text) = 0 Then
            MsgBox("Debe digitar la Cantidad de Horas Correctamente", vbInformation, "Mensaje del Sistema")
            Me.TextBox3.Focus()
            Exit Sub
        End If
    ...
    Private Sub GRABAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "INSERT INTO [CAT DE TIPO DE HORARIO] (ID_T_HORARIO, DESCRIPCION, HORA_E, HORA_S, CHRT, C_DIAS_T, C_DIAS_L, F_CAMBIA)" &
                                  "values (" & CInt(Me.TextBox1.Text) & ", '" & Trim(Me.TextBox2.Text) & "', '" & HORA1 & "', '" & HORA2 & "', " & CInt(Me.TextBox3.Text) & ", " & CInt(Me.TextBox4.Text) & ", " & CInt(Me.TextBox5.Text) & ", '" & Me.CheckBox1.Checked & "')"
