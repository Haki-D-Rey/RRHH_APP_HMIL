...
Public Class Frm_Cat_Estructura_N5_Upd
    Private Sub Frm_Cat_Estructura_N5_Upd_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Cat_Estructura_N5_Upd_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = n5ID_N5
        ...
        Me.TextBox2.Text = n5ORD5
        Me.TextBox3.Text = n5D_N5
        Me.TextBox4.Text = n5SIGLAS
        Call CARGAR_COMBO_CAT_DE_TIPO_DE_ESTRUCTURA()
        Me.ComboBox1.Text = n5D_T_ES
        Me.CheckBox1.Checked = n5MIXTA
        Me.CheckBox2.Checked = n5MILITAR
        Me.CheckBox3.Checked = n5PAME
        Me.TextBox2.Focus()
    ...
    Private Sub EDITAR_REGISTRO()
        ...
        Dim MiSqlCommand As SqlCommand = Conexion.CxRRHH.CreateCommand
        Try
            MiSqlCommand.CommandText = "UPDATE [CAT DE ESTRUCTURA NIVEL 5] SET ID_N4 = " & Me.ComboBox5.SelectedValue & ", ORDEN = '" & Trim(Me.TextBox2.Text) & "', DESCRIPCION= '" & Trim(Me.TextBox3.Text) & "', SIGLAS = '" & Trim(Me.TextBox4.Text) & "', ID_T_ES = " & Me.ComboBox1.SelectedValue & ", MIXTA = '" & Me.CheckBox1.Checked & "', MILITAR = '" & Me.CheckBox2.Checked & "', PAME = '" & Me.CheckBox3.Checked & "' WHERE ID_N5 = " & CInt(Me.TextBox1.Text) & ""
            MiSqlCommand.ExecuteNonQuery()
        Catch ex As Exception
            MsgBox("Error: " & ex.Message, vbInformation, "Mensaje del Sistema")
        Finally
