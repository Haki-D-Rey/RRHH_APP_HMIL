...
Public Class Frm_Cat_Estructura_N6_Upd
    Private Sub Frm_Cat_Estructura_N6_Upd_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Cat_Estructura_N6_Upd_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = n6ID_N6
        ...
        Me.TextBox2.Text = n6ORD6
        Me.TextBox3.Text = n6D_N6
        Me.TextBox4.Text = n6SIGLAS
        Call CARGAR_COMBO_CAT_DE_TIPO_DE_ESTRUCTURA()
        Me.ComboBox1.Text = n6D_T_ES
        Me.CheckBox1.Checked = n6MIXTA
        Me.CheckBox2.Checked = n6MILITAR
        Me.CheckBox3.Checked = n6PAME
        Me.TextBox2.Focus()
    ...
    Private Sub EDITAR_REGISTRO()
        ...
        Dim MiSqlCommand As SqlCommand = Conexion.CxRRHH.CreateCommand
        Try
            MiSqlCommand.CommandText = "UPDATE [CAT DE ESTRUCTURA NIVEL 6] SET ID_N5 = " & Me.ComboBox6.SelectedValue & ", ORDEN = '" & Trim(Me.TextBox2.Text) & "', DESCRIPCION= '" & Trim(Me.TextBox3.Text) & "', SIGLAS = '" & Trim(Me.TextBox4.Text) & "', ID_T_ES = " & Me.ComboBox1.SelectedValue & ", MIXTA = '" & Me.CheckBox1.Checked & "', MILITAR = '" & Me.CheckBox2.Checked & "', PAME = '" & Me.CheckBox3.Checked & "' WHERE ID_N6 = " & CInt(Me.TextBox1.Text) & ""
            MiSqlCommand.ExecuteNonQuery()
        Catch ex As Exception
            MsgBox("Error: " & ex.Message, vbInformation, "Mensaje del Sistema")
        Finally
