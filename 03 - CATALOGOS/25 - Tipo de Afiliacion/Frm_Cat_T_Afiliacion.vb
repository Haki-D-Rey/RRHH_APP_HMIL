...
Public Class Frm_Cat_T_Afiliacion
    Private Sub Frm_Cat_T_Afiliacion_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button7_Click(sender As Object, e As System.EventArgs) Handles Button7.Click
        Me.Close()
    End Sub
    Private Sub Frm_Cat_T_Afiliacion_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE TIPO DE AFILIACION] ORDER BY ID_T_AFILIACION", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE TIPO DE AFILIACION]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE TIPO DE AFILIACION]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        ...
        Me.DGV.Columns(2).HeaderText = "Patronal"
        ...
        Me.DGV.Columns(3).HeaderText = "Laboral"
        ...
        Me.DGV.Columns(3).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
    End Sub
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        Dim I As Integer
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(0, I).Value = c19ID_T_AFILIACION Then
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE TIPO DE AFILIACION] WHERE ID_T_AFILIACION = " & CInt(c19ID_T_AFILIACION) & ""
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c19ID_T_AFILIACION = Me.DGV.Item(0, I).Value
                    c19DESCRIPCION = Me.DGV.Item(1, I).Value
                    c19P_PATRONAL = Me.DGV.Item(2, I).Value
                    c19P_LABORAL = Me.DGV.Item(3, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_T_Afiliacion.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c19ID_T_AFILIACION = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Editar_T_Afiliacion.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "TIPO DE AFILIACION (" & UCase(Now) & ")")
        Catch ex As Exception
