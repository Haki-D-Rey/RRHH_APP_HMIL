...
Public Class Frm_Cat_Causas_Reales
    Private Sub Frm_Cat_Causas_Reales_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button7_Click(sender As Object, e As System.EventArgs) Handles Button7.Click
        Me.Close()
    End Sub
    Private Sub Frm_Cat_Causas_Reales_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        DGV.DataSource = MiDataSet.Tables("[VISTA CAT DE SUB TIPO DE MOVIMIENTO REAL DE EXP]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        Me.DGV.Columns(0).HeaderText = "D_T_M_EXP"
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(2, I).Value = c33ID_ST_M_R_EXP Then
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE SUB TIPO DE MOVIMIENTO REAL DE EXP] WHERE ID_ST_M_R_EXP = " & CInt(c33ID_ST_M_R_EXP) & ""
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c33ID_T_M_EXP = Me.DGV.Item(0, I).Value
                    c33D_T_M_EXP = Me.DGV.Item(1, I).Value
                    c33ID_ST_M_R_EXP = Me.DGV.Item(2, I).Value
                    c33D_ST_M_R_EXP = Me.DGV.Item(3, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_Causas_Reales.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c33ID_ST_M_R_EXP = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Editar_Causas_Reales.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "CAUSAS REALES DE MOVIMIENTOS (" & UCase(Now) & ")")
        Catch ex As Exception
