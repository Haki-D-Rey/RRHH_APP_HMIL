...
Public Class Frm_Cat_Contratos_y_Evaluaciones
    Private Sub Frm_Cat_Contratos_y_Evaluaciones_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Contratos_y_Evaluaciones_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE CONTRATOS] ORDER BY ID_CONT", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE CONTRATOS]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE CONTRATOS]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        ...
        Me.DGV.Columns(1).HeaderText = "Situacion"
        Me.DGV.Columns(1).Width = 950
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(0, I).Value = c45ID_CONT Then
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c45ID_CONT = Me.DGV.Item(0, I).Value
                    c45DESCRIPCION = Me.DGV.Item(1, I).Value
                    c45ACTIVO = Me.DGV.Item(2, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE CONTRATOS] WHERE ID_CONT = " & CInt(c45ID_CONT) & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_Contratos_y_Evaluaciones.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c45ID_CONT = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Editar_Contratos_y_Evaluaciones.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "CONTRATOS Y EVALUACIONES (" & UCase(Now) & ")")
        Catch ex As Exception
