...
Public Class Frm_Cat_Dosis
    Private Sub Frm_Cat_Dosis_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Dosis_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE DOSIS] ORDER BY ID_DOSIS", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE DOSIS]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE DOSIS]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        ...
        Me.DGV.Columns(1).HeaderText = "Dosis"
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(0, I).Value = c50ID_DOSIS Then
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c50ID_DOSIS = Me.DGV.Item(0, I).Value
                    c50DESCRIPCION = Me.DGV.Item(1, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE DOSIS] WHERE ID_DOSIS = " & CInt(c50ID_DOSIS) & ""
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "DOSIS (" & UCase(Now) & ")")
        Catch ex As Exception
