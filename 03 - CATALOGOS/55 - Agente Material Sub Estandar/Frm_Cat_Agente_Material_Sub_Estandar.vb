...
Public Class Frm_Cat_Agente_Material_Sub_Estandar
    Private Sub Frm_Cat_Agente_Material_Sub_Estandar_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Agente_Material_Sub_Estandar_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE AGENTE MATERIAL SUB ESTANDAR] ORDER BY ID_AMSE", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE AGENTE MATERIAL SUB ESTANDAR]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE AGENTE MATERIAL SUB ESTANDAR]")
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE AGENTE MATERIAL SUB ESTANDAR] WHERE ID_AMSE = " & CInt(c44ID_F) & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agente_Material_Sub_Estandar_Add.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c44ID_F = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Agente_Material_Sub_Estandar_Upd.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "AGENTE MATERIAL SUB ESTANDAR (" & UCase(Now) & ")")
        Catch ex As Exception
