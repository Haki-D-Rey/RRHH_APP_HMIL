...
Public Class Frm_Cat_Tipo_de_Sit_Personal
    Private Sub Frm_Cat_Tipo_de_Sit_Personal_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Tipo_de_Sit_Personal_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE TIPO DE SITUACION DE PERSONAL] ORDER BY ID_T_SIT_P", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE TIPO DE SITUACION DE PERSONAL]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE TIPO DE SITUACION DE PERSONAL]")
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(0, I).Value = c42ID_T_SIT_P Then
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c42ID_T_SIT_P = Me.DGV.Item(0, I).Value
                    c42DESCRIPCION = Me.DGV.Item(1, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE TIPO DE SITUACION DE PERSONAL] WHERE ID_T_SIT_P = " & CInt(c42ID_T_SIT_P) & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_Tipo_de_Sit_Personal.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c42ID_T_SIT_P = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Editar_Tipo_de_Sit_Personal.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "TIPO DE SITUACION DE PERSONAL (" & UCase(Now) & ")")
        Catch ex As Exception
