...
Public Class Frm_Cat_E_Tercerizadas
    Private Sub Frm_Cat_E_Tercerizadas_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_E_Tercerizadas_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE EMPRESAS TERCERIZADAS] ORDER BY ID_E_T", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE EMPRESAS TERCERIZADAS]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE EMPRESAS TERCERIZADAS]")
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE EMPRESAS TERCERIZADAS] WHERE ID_E_T = " & CInt(c44ID_F) & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_E_Tercerizadas_Add.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c44ID_F = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_E_Tercerizadas_Upd.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "EMPRESAS TERCERIZADAS (" & UCase(Now) & ")")
        Catch ex As Exception
