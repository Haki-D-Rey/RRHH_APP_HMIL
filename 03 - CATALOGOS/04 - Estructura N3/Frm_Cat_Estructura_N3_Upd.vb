...
Public Class Frm_Cat_Estructura_N3_Upd
    Private Sub Frm_Cat_Estructura_N3_Upd_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Cat_Estructura_N3_Upd_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = n3ID_N3
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Me.Close()
    End Sub
    Private Sub EDITAR_REGISTRO_EN_N1_N2_N3_EN_MAESTRO_DE_CARGO()
        '    If Conexion.CxRRHH.State = ConnectionState.Open Then
        '        Conexion.CBD_RRHH()
        '    End If
        '    Conexion.ABD_RRHH()
    ...
    Private Sub EDITAR_REGISTRO()
        ...
        Dim MiSqlCommand As SqlCommand = Conexion.CxRRHH.CreateCommand
        Try
            MiSqlCommand.CommandText = "UPDATE [CAT DE ESTRUCTURA NIVEL 3] SET ID_N2 = " & Me.ComboBox3.SelectedValue & ", ORDEN = '" & Trim(Me.TextBox2.Text) & "', DESCRIPCION= '" & Trim(Me.TextBox3.Text) & "', SIGLAS = '" & Trim(Me.TextBox4.Text) & "', ID_T_ES = " & Me.ComboBox1.SelectedValue & ", MIXTA = '" & Me.CheckBox1.Checked & "', MILITAR = '" & Me.CheckBox2.Checked & "', PAME = '" & Me.CheckBox3.Checked & "' WHERE ID_N3 = " & CInt(Me.TextBox1.Text) & ""
            MiSqlCommand.ExecuteNonQuery()
        Catch ex As Exception
            MsgBox("Error: " & ex.Message, vbInformation, "Mensaje del Sistema")
        Finally
