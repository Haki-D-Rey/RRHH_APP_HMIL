...
Public Class Frm_Cat_Nivel_Prof
    Private Sub Frm_Cat_Nivel_Prof_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Nivel_Prof_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE NIVEL PROFESIONAL] ORDER BY ID_N_PROFESIONAL", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE NIVEL PROFESIONAL]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE NIVEL PROFESIONAL]")
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(0, I).Value = c10ID_N_PROFESIONAL Then
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE NIVEL PROFESIONAL] WHERE ID_N_PROFESIONAL = " & CInt(c10ID_N_PROFESIONAL) & ""
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c10ID_N_PROFESIONAL = Me.DGV.Item(0, I).Value
                    c10DESCRIPCION = Me.DGV.Item(1, I).Value
                    c10SIGLAS = Me.DGV.Item(2, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_Nivel_Prof.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c10ID_N_PROFESIONAL = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Editar_Nivel_Prof.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "NIVEL PROFESIONAL (" & UCase(Now) & ")")
        Catch ex As Exception
