...
Public Class Frm_Cat_Nivel_de_Gravedad
    Private Sub Frm_Cat_Nivel_de_Gravedad_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Nivel_de_Gravedad_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE NIVEL DE GRAVEDAD] ORDER BY ID_NG", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE NIVEL DE GRAVEDAD]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE NIVEL DE GRAVEDAD]")
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE NIVEL DE GRAVEDAD] WHERE ID_NG = " & CInt(c44ID_F) & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Nivel_de_Gravedad_Add.ShowDialog()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "NIVEL DE GRAVEDAD (" & UCase(Now) & ")")
        Catch ex As Exception
