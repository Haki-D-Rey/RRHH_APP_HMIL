...
Public Class Frm_Cat_Estructura_N4_Upd
    Private Sub Frm_Cat_Estructura_N4_Upd_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Cat_Estructura_N4_Upd_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = n4ID_N4
        ...
        'Call GENERAR_ORDEN()
        Me.TextBox2.Text = n4ORD4
        Me.TextBox3.Text = n4D_N4
        Me.TextBox4.Text = n4SIGLAS
        Call CARGAR_COMBO_CAT_DE_TIPO_DE_ESTRUCTURA()
        Me.ComboBox1.Text = n4D_T_ES
        Me.CheckBox1.Checked = n4MIXTA
        Me.CheckBox2.Checked = n4MILITAR
        Me.CheckBox3.Checked = n4PAME
        Me.TextBox2.Focus()
    ...
    Private Sub EDITAR_REGISTRO()
        ...
        Dim MiSqlCommand As SqlCommand = Conexion.CxRRHH.CreateCommand
        Try
            MiSqlCommand.CommandText = "UPDATE [CAT DE ESTRUCTURA NIVEL 4] SET ID_N3 = " & Me.ComboBox4.SelectedValue & ", ORDEN = '" & Trim(Me.TextBox2.Text) & "', DESCRIPCION= '" & Trim(Me.TextBox3.Text) & "', SIGLAS = '" & Trim(Me.TextBox4.Text) & "', ID_T_ES = " & Me.ComboBox1.SelectedValue & ", MIXTA = '" & Me.CheckBox1.Checked & "', MILITAR = '" & Me.CheckBox2.Checked & "', PAME = '" & Me.CheckBox3.Checked & "' WHERE ID_N4 = " & CInt(Me.TextBox1.Text) & ""
            MiSqlCommand.ExecuteNonQuery()
        Catch ex As Exception
            MsgBox("Error: " & ex.Message, vbInformation, "Mensaje del Sistema")
        Finally
