...
Public Class Frm_Cat_Estructura_N4
    Private Sub Frm_Cat_Estructura_N4_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Estructura_N4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        DGV.DataSource = MiDataSet.Tables("[VISTA CAT DE ESTRUCTURA NIVEL 4]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        ...
        Me.DGV.Columns(10).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DGV.Columns(10).DefaultCellStyle.BackColor = Color.Khaki

        Me.DGV.Columns(11).HeaderText = "Descripcion N4"
        Me.DGV.Columns(11).Width = 190
        Me.DGV.Columns(11).Visible = True
        Me.DGV.Columns(11).HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter
        Me.DGV.Columns(11).DefaultCellStyle.BackColor = Color.LightGreen

        Me.DGV.Columns(12).HeaderText = "Siglas"
        ...
        Me.DGV.Columns(13).HeaderText = "ID_T_ES"
        ...
        Me.DGV.Columns(14).HeaderText = "Tipo"
        ...
        Me.DGV.Columns(17).HeaderText = "Pame"
        Me.DGV.Columns(17).Width = 40
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(9, I).Value = n4ID_N4 Then
                Me.DGV.Rows(I).Selected = True
                Me.DGV.CurrentCell = Me.DGV.Item(9, I)
                Exit Sub
            End If
        Next
    End Sub
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If HAY_CARGOS = True Then
            MsgBox("No se puede Eliminar este registro ya que contiene Estructuras\ Cargos de Dependencias en el Nivel 5", vbInformation, "Mensaje del Sistema")
            Exit Sub
        End If
    ...
    Private Sub VERIFICAR_ESTRUCTURAS()
        ...
        Try
            Conexion.ABD_RRHH()
            MiDataAdapter = New SqlDataAdapter("SELECT * FROM [MAESTRO DE CARGOS] WHERE ID_N1 = " & n4ID_N1 & " AND ID_N2 = " & n4ID_N2 & " AND ID_N3 = " & n4ID_N3 & " AND ID_N4 = " & n4ID_N4 & "", Conexion.CxRRHH)
            MiDataTable.Clear()
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE ESTRUCTURA NIVEL 4] WHERE ID_N4 = " & CInt(n4ID_N4) & ""
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    n4ID_N1 = Me.DGV.Item(0, I).Value
                    n4ORD1 = Me.DGV.Item(1, I).Value
                    n4D_N1 = Me.DGV.Item(2, I).Value
                    n4ID_N2 = Me.DGV.Item(3, I).Value
                    n4ORD2 = Me.DGV.Item(4, I).Value
                    n4D_N2 = Me.DGV.Item(5, I).Value
                    n4ID_N3 = Me.DGV.Item(6, I).Value
                    n4ORD3 = Me.DGV.Item(7, I).Value
                    n4D_N3 = Me.DGV.Item(8, I).Value
                    n4ID_N4 = Me.DGV.Item(9, I).Value
                    n4ORD4 = Me.DGV.Item(10, I).Value
                    n4D_N4 = Me.DGV.Item(11, I).Value
                    n4SIGLAS = Me.DGV.Item(12, I).Value
                    n4ID_T_ES = Me.DGV.Item(13, I).Value
                    n4D_T_ES = Me.DGV.Item(14, I).Value
                    n4MIXTA = Me.DGV.Item(15, I).Value
                    n4MILITAR = Me.DGV.Item(16, I).Value
                    n4PAME = Me.DGV.Item(17, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Estructura_N4_Add.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If n4ID_N4 = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Estructura_N4_Upd.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "ESTRUCTURA NIVEL 4 (" & UCase(Now) & ")")
        Catch ex As Exception
