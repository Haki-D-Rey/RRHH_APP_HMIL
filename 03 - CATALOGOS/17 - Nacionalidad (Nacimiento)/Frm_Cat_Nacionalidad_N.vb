...
Public Class Frm_Cat_Nacionalidad_N
    Private Sub Frm_Cat_Nacionalidad_N_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button7_Click(sender As Object, e As System.EventArgs) Handles Button7.Click
        Me.Close()
    End Sub
    Private Sub Frm_Cat_Nacionalidad_N_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE NACIONALIDAD_N] ORDER BY ID_NACIONALIDAD_N", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE NACIONALIDAD_N]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE NACIONALIDAD_N]")
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(0, I).Value = c11ID_NACIONALIDAD_N Then
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If c11ID_NACIONALIDAD_N = 0 Then
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE NACIONALIDAD_N] WHERE ID_NACIONALIDAD_N = " & CInt(c11ID_NACIONALIDAD_N) & ""
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c11ID_NACIONALIDAD_N = Me.DGV.Item(0, I).Value
                    c11DESCRIPCION = Me.DGV.Item(1, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_Nacionalidad_N.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c11ID_NACIONALIDAD_N = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Editar_Nacionalidad_N.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "NACIONALIDAD (NACIMIENTO) (" & UCase(Now) & ")")
        Catch ex As Exception
