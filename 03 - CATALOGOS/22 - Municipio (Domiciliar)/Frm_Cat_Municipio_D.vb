...
Public Class Frm_Cat_Municipio_D
    Private Sub Frm_Cat_Municipio_D_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button7_Click(sender As Object, e As System.EventArgs) Handles Button7.Click
        Me.Close()
    End Sub
    Private Sub Frm_Cat_Municipio_D_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        DGV.DataSource = MiDataSet.Tables("[VISTA CAT DE MUNICIPIO_D]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        Me.DGV.Columns(0).HeaderText = "ID_DPTO_D"
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(2, I).Value = c16ID_M_D Then
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE MUNICIPIO_D] WHERE ID_M_D = " & CInt(c16ID_M_D) & ""
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c16ID_DPTO_D = Me.DGV.Item(0, I).Value
                    c16D_DPTO_D = Me.DGV.Item(1, I).Value
                    c16ID_M_D = Me.DGV.Item(2, I).Value
                    c16DESCRIPCION = Me.DGV.Item(3, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_Municipio_D.ShowDialog()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "MUNICIPIO (DOMICILIAR) (" & UCase(Now) & ")")
        Catch ex As Exception
