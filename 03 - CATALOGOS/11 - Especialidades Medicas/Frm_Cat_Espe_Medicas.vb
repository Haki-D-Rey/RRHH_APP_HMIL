...
Public Class Frm_Cat_Espe_Medicas
    Private Sub Frm_Cat_Espe_Medicas_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Espe_Medicas_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [VISTA CAT DE ESPECIALIDADES MEDICAS] ORDER BY ID_T_ESTUDIO, D_E_MED", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[VISTA CAT DE ESPECIALIDADES MEDICAS]")
        DGV.DataSource = MiDataSet.Tables("[VISTA CAT DE ESPECIALIDADES MEDICAS]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        Me.DGV.Columns(0).HeaderText = "ID_T_ESTUDIO"
        ...
        Me.DGV.Columns(1).HeaderText = "Tipo de Estudio"
        ...
        Me.DGV.Columns(3).HeaderText = "Especialidad"
        Me.DGV.Columns(3).Width = 800
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(2, I).Value = c5ID_E_MED Then
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE ESPECIALIDADES MEDICAS] WHERE ID_E_MED = " & CInt(c5ID_E_MED) & ""
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c5ID_T_ESTUDIO = Me.DGV.Item(0, I).Value
                    c5D_T_ESTUDIO = Me.DGV.Item(1, I).Value
                    c5ID_E_MED = Me.DGV.Item(2, I).Value
                    c5DESCRIPCION = Me.DGV.Item(3, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_Espe_Medicas.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c5ID_E_MED = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Editar_Espe_Medicas.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "ESPECIALIDADES MEDICAS (" & UCase(Now) & ")")
        Catch ex As Exception
