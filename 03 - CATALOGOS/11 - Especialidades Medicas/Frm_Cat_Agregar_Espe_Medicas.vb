...
Public Class Frm_Cat_Agregar_Espe_Medicas
    Private Sub Frm_Cat_Agregar_Espe_Medicas_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = ""
    ...
    Private Sub Button2_Click(sender As Object, e As System.EventArgs) Handles Button2.Click
        ...
        Me.Close()
    End Sub
    Private Sub Frm_Cat_Agregar_Espe_Medicas_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub GENERAR_CODIGO()
        ...
        Conexion.ABD_RRHH()
        Try
            MiDataAdapter = New SqlDataAdapter("SELECT ID_E_MED FROM [CAT DE ESPECIALIDADES MEDICAS] ORDER BY ID_E_MED", Conexion.CxRRHH)
            MiDataTable.Clear()
    ...
    Private Sub GRABAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "INSERT INTO [CAT DE ESPECIALIDADES MEDICAS] (ID_T_ESTUDIO, ID_E_MED, DESCRIPCION)" &
