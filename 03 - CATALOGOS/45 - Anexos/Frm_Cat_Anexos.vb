...
Public Class Frm_Cat_Anexos
    Private Sub Frm_Cat_Anexos_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button7_Click(sender As Object, e As System.EventArgs) Handles Button7.Click
        Me.Close()
    End Sub
    Private Sub Frm_Cat_Anexos_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        DGV.DataSource = MiDataSet.Tables("[VISTA CAT DE ANEXOS]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        Me.DGV.Columns(0).HeaderText = "ID_T_ANEXO"
        ...
        Me.DGV.Columns(3).HeaderText = "Anexo"
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(2, I).Value = c36ID_ANEXO Then
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c36ID_T_ANEXO = Me.DGV.Item(0, I).Value
                    c36D_T_ANEXO = Me.DGV.Item(1, I).Value
                    c36ID_ANEXO = Me.DGV.Item(2, I).Value
                    c36D_ANEXO = Me.DGV.Item(3, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE ANEXOS] WHERE ID_ANEXO = " & CInt(c36ID_ANEXO) & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_Anexos.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c36ID_ANEXO = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Editar_Anexos.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "ANEXOS (" & UCase(Now) & ")")
        Catch ex As Exception
