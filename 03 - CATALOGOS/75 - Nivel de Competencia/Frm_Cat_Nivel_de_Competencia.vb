...
Public Class Frm_Cat_Nivel_de_Competencia
    Private Sub Frm_Cat_Nivel_de_Competencia_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Nivel_de_Competencia_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE NIVEL DE COMPETENCIA] ORDER BY ID_N_COMPETENCIA", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE NIVEL DE COMPETENCIA]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE NIVEL DE COMPETENCIA]")
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(0, I).Value = c46ID_N_COMPETENCIA Then
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c46ID_N_COMPETENCIA = Me.DGV.Item(0, I).Value
                    c46DESCRIPCION = Me.DGV.Item(1, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE NIVEL DE COMPETENCIA] WHERE ID_N_COMPETENCIA = " & CInt(c46ID_N_COMPETENCIA) & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Nivel_de_Competencia_Add.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c46ID_N_COMPETENCIA = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Nivel_de_Competencia_Upd.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "NIVEL DE COMPETENCIA (" & UCase(Now) & ")")
        Catch ex As Exception
