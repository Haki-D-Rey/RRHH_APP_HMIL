...
Public Class Frm_Cat_Establecimientos
    Private Sub Frm_Cat_Establecimientos_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Establecimientos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE ESTABLECIMIENTO] ORDER BY ID_ESTABLECIMIENTO", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE ESTABLECIMIENTO]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE ESTABLECIMIENTO]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        ...
        Me.DGV.Columns(1).HeaderText = "Establecimiento"
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(0, I).Value = c47ID_ESTABLECIMIENTO Then
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c47ID_ESTABLECIMIENTO = Me.DGV.Item(0, I).Value
                    c47DESCRIPCION = Me.DGV.Item(1, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If c47ID_ESTABLECIMIENTO = 0 Then
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE ESTABLECIMIENTO] WHERE ID_ESTABLECIMIENTO  = " & CInt(c47ID_ESTABLECIMIENTO) & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Establecimientos_Add.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c47ID_ESTABLECIMIENTO = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Establecimientos_Upd.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "ESTABLECIMIENTOS (" & UCase(Now) & ")")
        Catch ex As Exception
