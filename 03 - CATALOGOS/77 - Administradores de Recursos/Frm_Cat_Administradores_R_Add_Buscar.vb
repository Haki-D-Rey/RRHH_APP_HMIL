...
Public Class Frm_Cat_Administradores_R_Add_Buscar
    Private Sub Frm_Cat_Administradores_R_Add_Buscar_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Cat_Administradores_R_Add_Buscar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = "0"
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        CADENAsql = "Select * from [VISTA MAESTRO DE CARGOS SIT 4] WHERE ID_SITUACION = '1' AND (AN LIKE '%" & Me.TextBox2.Text & "%') ORDER BY AN"
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        ...
        Me.DGV.Columns(44).HeaderText = "D_SITUACION"
        ...
        Me.DGV.Columns(50).HeaderText = "D_ESTABLECIMIENTO"
        ...
        Me.DGV.Columns(52).HeaderText = "FEC_ING_PAME"
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    ...
                    bEMPLEADO = Me.DGV.Item(42, I).Value
                    Exit Sub
                End If
            Next
        End If
