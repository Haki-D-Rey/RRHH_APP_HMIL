...
Public Class Frm_Cat_Agregar_Sit_Personal
    Private Sub Frm_Cat_Agregar_Sit_Personal_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Cat_Agregar_Sit_Personal_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
        Me.TextBox1.Text = ""
        Me.TextBox2.Text = ""
    ...
    Private Sub GENERAR_CODIGO()
        ...
        Conexion.ABD_RRHH()
        Try
            MiDataAdapter = New SqlDataAdapter("SELECT ID_SIT_P FROM [CAT DE SITUACION DE PERSONAL] ORDER BY ID_SIT_P", Conexion.CxRRHH)
            MiDataTable.Clear()
    ...
    Private Sub GRABAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "INSERT INTO [CAT DE SITUACION DE PERSONAL] (ID_T_SIT_P, ID_SIT_P, DESCRIPCION, SIGLA)" &
                                  "values (" & CInt(Me.ComboBox1.SelectedValue) & ",'" & Trim(Me.TextBox1.Text) & "', '" & Trim(Me.TextBox2.Text) & "', '" & Trim(Me.TextBox3.Text) & "')"
