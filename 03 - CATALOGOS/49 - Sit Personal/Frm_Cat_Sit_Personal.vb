...
Public Class Frm_Cat_Sit_Personal
    Private Sub Frm_Cat_Sit_Personal_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button7_Click(sender As Object, e As System.EventArgs) Handles Button7.Click
        Me.Close()
    End Sub
    Private Sub Frm_Cat_Sit_Personal_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [VISTA CAT DE SITUACION DE PERSONAL] ORDER BY ID_T_SIT_P, ID_SIT_P", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[VISTA CAT DE SITUACION DE PERSONAL]")
        DGV.DataSource = MiDataSet.Tables("[VISTA CAT DE SITUACION DE PERSONAL]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        Me.DGV.Columns(0).HeaderText = "ID_T_SIT_P"
        Me.DGV.Columns(0).Width = 0
        Me.DGV.Columns(0).Visible = False

        Me.DGV.Columns(1).HeaderText = "Tipo"
        ...
        Me.DGV.Columns(4).HeaderText = "Siglas"
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(2, I).Value = c43ID_SIT_P Then
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c43ID_T_SIT_P = Me.DGV.Item(0, I).Value
                    c43D_T_SIT_P = Me.DGV.Item(1, I).Value
                    c43ID_SIT_P = Me.DGV.Item(2, I).Value
                    c43D_SIT_P = Me.DGV.Item(3, I).Value
                    c43SIGLA = Me.DGV.Item(4, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE SITUACION DE PERSONAL] WHERE ID_SIT_P = " & CInt(c43ID_SIT_P) & ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_Sit_Personal.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c43ID_SIT_P = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Editar_Sit_Personal.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "SITUACION DE PERSONAL (" & UCase(Now) & ")")
        Catch ex As Exception
