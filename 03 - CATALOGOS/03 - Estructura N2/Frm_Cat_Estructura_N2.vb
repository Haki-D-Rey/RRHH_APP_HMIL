...
Public Class Frm_Cat_Estructura_N2
    Private Sub Frm_Cat_Estructura_N2_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_Estructura_N2_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        DGV.DataSource = MiDataSet.Tables("[VISTA CAT DE ESTRUCTURA NIVEL 2]")
    ...
    Private Sub ARMAR_DATAGRIDVIEW()
        ...
        Me.DGV.Columns(1).HeaderText = "ID_N1"
        Me.DGV.Columns(1).Width = 0
        Me.DGV.Columns(1).Visible = False

        Me.DGV.Columns(2).HeaderText = "Orden N1"
        ...
        Me.DGV.Columns(8).HeaderText = "Descripcion N2"
        Me.DGV.Columns(8).Width = 275
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(0, I).Value = c3ID_N2 Then
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If HAY_CARGOS = True Then
            MsgBox("No se puede Eliminar este registro ya que contiene Estructuras\ Cargos de Dependencias en el Nivel 3", vbInformation, "Mensaje del Sistema")
            Exit Sub
        End If
        MENSAJE = MsgBox("¿Esta seguro de Eliminar el registro seleccionado?", vbInformation + vbYesNo, "Mensaje del Sistema")
        If MENSAJE = vbYes Then
            Call ELIMINAR_REGISTRO_MAESTRO_DE_USUARIOS_DEPARTAMENTOS_SERVICIOS()
    ...
    Private Sub VERIFICAR_ESTRUCTURAS()
        ...
        Try
            Conexion.ABD_RRHH()
            MiDataAdapter = New SqlDataAdapter("SELECT * FROM [MAESTRO DE CARGOS] WHERE ID_N1 = " & n3ID_N1 & " AND ID_N2 = " & n3ID_N2 & "", Conexion.CxRRHH)
            MiDataTable.Clear()
        ...
        End Try
    End Sub
    Private Sub ELIMINAR_REGISTRO_MAESTRO_DE_USUARIOS_DEPARTAMENTOS_SERVICIOS()
        If Conexion.CxRRHH.State = ConnectionState.Open Then
            Conexion.CBD_RRHH()
        End If
        Conexion.ABD_RRHH()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [MAESTRO DE USUARIOS DEPARTAMENTOS SERVICIOS] WHERE ID_N1 = " & CInt(c3ID_N1) & " AND ID_N2 = " & CInt(c3ID_N2) & ""
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Dim MiSqlCommand As SqlCommand = Conexion.CxRRHH.CreateCommand
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE ESTRUCTURA NIVEL 2] WHERE ID_N2 = " & CInt(c3ID_N2) & ""
            MiSqlCommand.ExecuteNonQuery()
        Catch ex As Exception
            MsgBox("Error: " & ex.Message, vbInformation, "Mensaje del Sistema")
        Finally
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c3ID_N2 = Me.DGV.Item(0, I).Value
                    c3ID_N1 = Me.DGV.Item(1, I).Value
                    c3ORDN1 = Me.DGV.Item(2, I).Value
                    c3D_N1 = Me.DGV.Item(3, I).Value
                    c3MIXTAN1 = Me.DGV.Item(4, I).Value
                    c3MILITARN1 = Me.DGV.Item(5, I).Value
                    c3PAMEN1 = Me.DGV.Item(6, I).Value
                    c3ORDN2 = Me.DGV.Item(7, I).Value
                    c3DESCRIPCION = Me.DGV.Item(8, I).Value
                    c3SIGLAS = Me.DGV.Item(9, I).Value
                    c3ID_T_ES = Me.DGV.Item(10, I).Value
                    c3D_T_ES = Me.DGV.Item(11, I).Value
                    c3MIXTA = Me.DGV.Item(12, I).Value
                    c3MILITAR = Me.DGV.Item(13, I).Value
                    c3PAME = Me.DGV.Item(14, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Frm_Cat_Agregar_Estructura_N2.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If c3ID_N2 = 0 Then
            ...
            Exit Sub
        End If
        Frm_Cat_Editar_Estructura_N2.ShowDialog()
        If CERRAR = False Then
            Call CARGAR_DATAGRIDVIEW()
            Call ARMAR_DATAGRIDVIEW()
            Call SELECCIONAR_REGISTRO_DATAGRIDVIEW()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "ESTRUCTURA NIVEL 2 (" & UCase(Now) & ")")
        Catch ex As Exception
    ...
    '    PARAMETRO = 1   'CATALOGO DE NIVEL 2
