...
Public Class Frm_Cat_GR
    Private Sub Frm_Cat_GR_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Escape) Then
            Me.Close()
        End If
    End Sub
    Private Sub Frm_Cat_GR_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR_DATAGRIDVIEW()
        ...
        End If
        Conexion.ABD_RRHH()
        Dim MiAdaptador As New SqlClient.SqlDataAdapter("Select * from [CAT DE GRADO REAL] ORDER BY ID_GR", Conexion.CxRRHH)
        Dim MiDataSet As New DataSet()
        MiAdaptador.Fill(MiDataSet, "[CAT DE GRADO REAL]")
        DGV.DataSource = MiDataSet.Tables("[CAT DE GRADO REAL]")
    ...
    Private Sub SELECCIONAR_REGISTRO_DATAGRIDVIEW()
        ...
        For I = 0 To Me.DGV.RowCount - 1
            If Me.DGV.Item(0, I).Value = c8ID_GR Then
    ...
    Private Sub ELIMINAR_REGISTRO()
        ...
        Try
            MiSqlCommand.CommandText = "DELETE FROM [CAT DE GRADO REAL] WHERE ID_GR = " & CInt(c8ID_GR) & ""
        ...
        If Me.DGV.RowCount > 0 Then
            For I = 0 To Me.DGV.RowCount - 1
                If DGV.Rows(I).Selected = True Then
                    c8ID_GR = Me.DGV.Item(0, I).Value
                    c8DESCRIPCION = Me.DGV.Item(1, I).Value
                    c8SIGLAS = Me.DGV.Item(2, I).Value
                    Exit Sub
                End If
            Next
        End If
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            ...
            EXPORTAR_DATOS_A_EXCEL(DGV, "GRADO REAL (" & UCase(Now) & ")")
        Catch ex As Exception
